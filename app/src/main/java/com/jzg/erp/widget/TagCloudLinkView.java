...
public class TagCloudLinkView extends RelativeLayout {
    ...
    private static final int INNER_VIEW_PADDING = 6;
...
//            tagLayout.setBackgroundColor(mTagLayoutColor);
            ...
            tagView.setPadding(INNER_VIEW_PADDING, 2, INNER_VIEW_PADDING, 2);
...
//            tagView.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTagTextSize);
            ...
            float tagWidth = tagView.getPaint().measureText(tag.getText())+ INNER_VIEW_PADDING * 2;  // tagView padding (left & right)
            ...
            LayoutParams tagParams = new LayoutParams(HEIGHT_WC, ScreenUtils.dip2px(getContext(),30));

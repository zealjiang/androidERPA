 ...
 * 主要零部件维修记录
 * @author zealjiang
 * @time 2016/8/12 17:28
 */
public class MCompMaintenanceActivity extends BaseActivity implements OnItemClickListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(screenWidth,screenWidth*375/640);
        params.topMargin = ScreenUtils.dip2px(this,10);
        ivInstruction.setLayoutParams(params);

        String imgUrl = carCondOptionsModel.getZylbjPic();
    ...
    public void init(){
        ...
        mList = new ArrayList<>();
        listOptions = carCondOptionsModel.getData().getKey184();

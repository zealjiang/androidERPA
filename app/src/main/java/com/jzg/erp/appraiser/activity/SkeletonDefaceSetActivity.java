 ...
 * 骨架损伤设置
 * @author zealjiang
 * @time 2016/8/12 15:59
 */
public class SkeletonDefaceSetActivity extends BaseActivity implements OnItemClickListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        String imgUrl = carCondOptionsModel.getGjssPic();
    ...
    public void init(){
        ...
        mList = new ArrayList<>();
        listOptions = carCondOptionsModel.getData().getKey183();

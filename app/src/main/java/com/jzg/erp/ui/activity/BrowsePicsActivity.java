...
import com.jzg.erp.widget.scalable.ZoomableDraweeView;
...
public class BrowsePicsActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            ...
            ZoomableDraweeView imageView = (ZoomableDraweeView) itemView.findViewById(R.id.imageView);
            DraweeController controller = Fresco.newDraweeControllerBuilder()
                    .setUri(mDataList.get(position))
                    .build();

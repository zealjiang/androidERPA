 ...
 */
public class ItemAdapter extends CommonAdapter<IdNameValue> {

    //为true，显示右边的箭头，false不显示
    private boolean isShowJianTout = true;

    public ItemAdapter(Context context, int layoutId, List<IdNameValue> datas, XRecyclerView xRecyclerView) {
        super(context, layoutId, datas, xRecyclerView);
    }

    @Override
    public void convert(ViewHolder holder, IdNameValue nameValue) {

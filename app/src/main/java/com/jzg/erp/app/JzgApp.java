...
public class JzgApp extends Application {
    ...
    private static SubmitParamWrapper submitParam = new SubmitParamWrapper();
    private static ParamOption option;


    public static ParamOption getOption() {
        if(option==null){
            option = (ParamOption) ACache.get(app).getAsObject("option");
        }
        return option;
    }

    public static void setOption(ParamOption option) {
        JzgApp.option = option;
    }

    /***
     *
     */
    public static  SubmitParamWrapper getSubmitParam() {
        return submitParam;
    }
